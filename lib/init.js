...
class Init {
  ...
  setDefaults() {
    nconf.defaults({
      bot: {
        prefix: 'm!',
        shard: 'no', // sharding is completely broken atm
        respondUnknown: false,
        selfbot: false, // selfbot mode is not fully supported
      },
      prometheus: {
        port: '9400',
      },
  ...
  initModules() {
    ...
    this.main.resourceLoader.loadTypeFiles();
    this.main.resourceLoader.loadCategory();
