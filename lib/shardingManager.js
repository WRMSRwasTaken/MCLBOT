...
class ShardingManager {
  ...
  async launchShards() { // TODO: there's still somewhere a rejected promise if a shard does not get ready in time
    this.shardManager = new this.main.Discord.ShardingManager(path.resolve('./', 'bot.ts'), {
    ...
    winston.info('Going to launch %d shards...', this.shardCount);
