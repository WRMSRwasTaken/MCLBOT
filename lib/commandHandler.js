...
class CommandHandler {
  ...
  async handleMessageEvent(message, editedMessage) {
    ...
    if (this.main.commands[inputCommand].owner && !this.main.stringUtils.isBotAdmin(messageToHandle)) {
    ...
    if (!this.main.stringUtils.isBotAdmin(messageToHandle) && redisResult) {
