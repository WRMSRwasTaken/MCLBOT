...
class CommandHandler {
  ...
  async handleCommand(message, inputCommand, inputCommandParams) {
    if (this.isDM(message)) {
      ...
      winston.info(`${inputCommand} by ${message.author.tag} (ID: ${message.author.id}) in channel #${message.channel.name} (ID: ${message.channel.id}) on server ${message.channel.guild.name} (ID: ${message.channel.guild.id})`);
    }
