...
class ResourceLoader {
  ...
  loadCommandFiles() {
    ...
    winston.debug(`Loaded ${this.main.loadedCommands} bot commands with ${this.main.loadedAliases} aliases from ${this.main.commandFilesCount} files.`);
  ...
  loadEventFiles() {
    ...
    winston.debug(`Loaded ${this.main.loadedEvents} events from ${this.main.eventFilesCount} files.`);
  }
  ...
  loadTaskFiles() {
    ...
    winston.debug(`Loaded ${this.main.loadedTasks} tasks from ${this.main.taskFilesCount} files.`);
  }
}
