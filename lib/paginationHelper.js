...
class PaginationHelper {
  ...
  async handleMessageReactionAddEvent(messageReaction, user) {
    ...
    winston.debug('imvoker user id', messageReaction.message.pagination.invokerUserID);
    winston.debug('react user id', user.id);
    winston.debug('same user?', messageReaction.message.pagination.invokerUserID === user.id);
